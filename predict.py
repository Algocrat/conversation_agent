...
class ConversationAgent(object):
    ...
    def __init__(self):
        self.input_word2idx = np.load('models/word-input-word2idx.npy').item()
        self.input_idx2word = np.load('models/word-input-idx2word.npy').item()
        self.target_word2idx = np.load('models/word-target-word2idx.npy').item()
        self.target_idx2word = np.load('models/word-target-idx2word.npy').item()
        context = np.load('models/word-context.npy').item()
        ...
        self.model.load_weights('models/word-weights.h5')
